%read file
data = load('/Volumes/kovi ssd/egyetem/7.felev-szakdoga/THUMB/patients/pt5_oiti37/awake/thumb2/oiti37_5_5_awake_thumb_2.mat');      
...
lfpdata = lfpdataread(:, 1:n_keep); %first4
%lfpdata = lfpdataread(:, 2*n_keep+1:3*n_keep); %from 8-12mins
%%
%save new data
save('oiti37_5_5_awake_th2_4mins1.mat', 'lfpdata', '-v7.3');
%%
clc
clear